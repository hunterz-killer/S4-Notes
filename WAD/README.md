...
1.  XML Validation: DTD and XSD
1.  XML Tags, Elements, and Attributes
1.  Variables, Control Statements, Loops
1.  Two-Way Data Binding
1.  Tables
1.  Styling Text, Fonts
1.  State Management in Web Applications: Cookies
1.  Server-Side Scripting and Difference with Client-Side Scripting
1.  Regular Expressions and Pattern Matching
1.  Pseudo-classes, Pseudo-elements
1.  PHP Forms and Global Variables
1.  MVC in AngularJS
...
1.  Introduction to PHP, Variables, Control Statements, Loops
1.  Introduction to JavaScript
1.  Introduction to AJAX
1.  Inputting and Outputting from Form Elements to JavaScript
1.  HTML5 Tags
...
1.  Forms
1.  Drawing 2D Shapes, Handling Events
1.  DOM Concept, Creating HTML Elements using JavaScript
1.  Database Programming: Inputting and Outputting Data from MySQL using PHP
1.  CSS Overflow, Float, Inline Blocks
1.  CSS Border Images, Rounded Corners
1.  Controllers and User Inputs
1.  Client-Side Routing and Accessing URL Data
1.  Background, Borders, Margin, Box Model
1.  Attribute Types in XML
1.  Arrays, String Handling
1.  Overview of AngularJS as a Framework for Building SPAs
1.  Arrays and String Handling in PHP
